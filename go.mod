...
require (
	...
	github.com/containers/image/v5 v5.35.1-0.20250711125451-ccfad4e90ac4
...
replace github.com/containers/image/v5 => github.com/mtrmac/image/v5 v5.0.0-20250711150727-cbd85c294dae
