...
PODMAN_SEQUOIA_COMMIT=10a6f2f003388741b8a912dd3b81d216fd3c2a26 # FIXME: drop
...
_run_build() {
    if [[ "$BUILDTAGS" =~ containers_image_sequoia ]]; then
        ...
        ln -sf libpodman_sequoia.so podman-sequoia/target/release/libpodman_sequoia.so.0 # FIXME: Drop after https://github.com/ueno/podman-sequoia/pull/2 is merged.
